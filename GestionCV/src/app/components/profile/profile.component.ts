...
export class ProfileComponent {
  ...
  onDelete(){
    if (confirm("Are you sure you want to delete your account") == true) {
      this.crudCandidate.deleteCandidate(this.authservice.userinfos.id).subscribe(data=>{
        this.messageService.add(
          { severity: 'warn', summary: 'Warn', detail: 'Sad to see you leave 🥲' }
      );
      setTimeout(() => {
      ...
      this.messageService.add(
        { severity: 'info', summary: 'info', detail: 'You won\'t regret it' }
    );
    }
